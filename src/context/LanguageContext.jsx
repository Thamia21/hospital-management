      ...
      try {
        ...
        const allTranslations = {
          ...
          ts: {
            ...
            // Patient Dashboard - isiNdebele
            'dashboard.welcome': 'Siyakwamukela',
            'dashboard.overview': 'Nanku uhlu lwemininingwane yakho yempilo kanye nemisebenzi ezayo.',
            'dashboard.upcomingAppointments': 'Ama-aphoyintimenti Azayo',
            'dashboard.noUpcomingAppointments': 'Awekho ama-aphoyintimenti azayo',
            'dashboard.viewAllAppointments': 'Buka Wonke Ama-aphoyintimenti',
            'dashboard.recentTestResults': 'Imiphumela Yokuhlolwa Yamuva',
            'dashboard.noRecentTestResults': 'Ayikho imiphumela yokuhlolwa yamuva',
            'dashboard.viewAllResults': 'Buka Yonke Imiphumela',
            'dashboard.quickActions': 'Izenzo Ezisheshayo',
            'dashboard.healthReminders': 'Izikhumbuzi Zempilo',
            'dashboard.medicationReminder': 'Khumbula ukuthatha imithi yakho yansuku zonke njengoba kuchaziwe.',
            'dashboard.appointmentReminder': 'Unama-aphoyintimenti angu-{{count}} azayo kuleli viki.',
            'dashboard.billReminder': 'Unamabhili angu-{{count}} alindile adinga ukunakwa.',
            'dashboard.activeMedications': 'Imithi Esebenzayo',
            'dashboard.pendingTests': 'Ukuhlolwa Okulindile',
            'dashboard.outstandingBalance': 'Ibhalansi Esele',
            'dashboard.healthSummary': 'Isifinyezo Sempilo',
            
            // Navigation - isiNdebele
            'nav.patientPortal': 'Isango Lesiguli',
            'nav.dashboard': 'I-Dashboard',
            'nav.healthSummary': 'Isifinyezo Sempilo',
            'nav.appointments': 'Ama-aphoyintimenti',
            'nav.medicalRecords': 'Amarekhodi Ezokwelapha',
            'nav.prescriptions': 'Amaphreskiripshini',
            'nav.testResults': 'Imiphumela Yokuhlolwa',
            'nav.billing': 'Ukubhayela',
            'nav.messages': 'Imiyalezo',
            'nav.profile': 'Iphrofayili',
            'nav.settings': 'Izilungiselelo',
            ...
            // Quick Actions - isiNdebele
            'quickActions.bookAppointment': 'Bhuka I-aphoyintimenti',
            'quickActions.bookAppointmentDesc': 'Hlela i-aphoyintimenti entsha nomhlinzeki wakho wempilo',
            'quickActions.messages': 'Imiyalezo',
            'quickActions.messagesDesc': 'Buka futhi uthumele imiyalezo eqenjini lakho lempilo',
            'quickActions.testResults': 'Buka Imiphumela Yokuhlolwa',
            'quickActions.testResultsDesc': 'Hlola imiphumela yakho yamuva yaselabhoratori nemibiko',
            'quickActions.prescriptions': 'Amaphreskiripshini',
            'quickActions.prescriptionsDesc': 'Phatha imithi yakho yamanje nokugcwalisa kabusha',
            'quickActions.medicalRecords': 'Amarekhodi Ezokwelapha',
            'quickActions.medicalRecordsDesc': 'Finyelela umlando wakho ophelele wezokwelapha',
            'quickActions.billing': 'Ukubhayela & Izinkokhelo',
            'quickActions.billingDesc': 'Buka amabhili futhi wenze izinkokhelo ku-inthanethi'
          },
          ...
          nso: {
            // Login page - Sepedi
            'login.title': 'Re go Amogela Gape',
            'login.subtitle': 'Tsena go fihlelela dashboard ya gago ya maphelo',
            'login.userId': 'ID ya Modiriši',
            'login.password': 'Phasewete',
            'login.signIn': 'Tsena',
            'login.forgotPassword': 'O lebetše Phasewete?',
            ...
            // Patient Dashboard - Sepedi
            'dashboard.welcome': 'Re go Amogela',
            'dashboard.overview': 'Mo ke kakaretšo ya tshedimošo ya gago ya maphelo le mešomo ye e tlago.',
            'dashboard.upcomingAppointments': 'Ditebelano tše di Tlago',
            'dashboard.noUpcomingAppointments': 'Ga go na ditebelano tše di tlago',
            'dashboard.viewAllAppointments': 'Lebelela Ditebelano Tšohle',
            'dashboard.recentTestResults': 'Dipoelo tša Diteko tša Bjale',
            'dashboard.noRecentTestResults': 'Ga go na dipoelo tša diteko tša bjale',
            'dashboard.viewAllResults': 'Lebelela Dipoelo Tšohle',
            'dashboard.quickActions': 'Ditiro tše di Bonako',
            'dashboard.healthReminders': 'Dikgopotšo tša Maphelo',
            'dashboard.medicationReminder': 'Gopola go tšea dihlare tša gago tša letšatši le letšatši bjalo ka ge go laetšwe.',
            'dashboard.appointmentReminder': 'O na le ditebelano tše {{count}} tše di tlago bekeng ye.',
            'dashboard.billReminder': 'O na le dibill tše {{count}} tše di emetšego tše di nyakago tlhokomelo.',
            'dashboard.activeMedications': 'Dihlare tše di Šomago',
            'dashboard.pendingTests': 'Diteko tše di Emetšego',
            'dashboard.outstandingBalance': 'Tekanyo ye e Šetšego',
            'dashboard.healthSummary': 'Kakaretšo ya Maphelo',
            
            // Navigation - Sepedi
            'nav.patientPortal': 'Lebokose la Molwetši',
            'nav.dashboard': 'Dashboard',
            'nav.healthSummary': 'Kakaretšo ya Maphelo',
            'nav.appointments': 'Ditebelano',
            'nav.medicalRecords': 'Direkoto tša Kalafi',
            'nav.prescriptions': 'Ditaelo tša Dihlare',
            'nav.testResults': 'Dipoelo tša Diteko',
            'nav.billing': 'Go Lefa',
            'nav.messages': 'Melaetša',
            'nav.profile': 'Profaele',
            'nav.settings': 'Dipeakanyo',
            'nav.logout': 'Tšwa',
            
            // Quick Actions - Sepedi
            'quickActions.bookAppointment': 'Beela Tebelano',
            'quickActions.bookAppointmentDesc': 'Rulaganya tebelano ye mpsha le mofani wa gago wa maphelo',
            'quickActions.messages': 'Melaetša',
            'quickActions.messagesDesc': 'Lebelela le go romela melaetša go sehlopha sa gago sa maphelo',
            'quickActions.testResults': 'Lebelela Dipoelo tša Diteko',
            'quickActions.testResultsDesc': 'Hlahloba dipoelo tša gago tša bjale tša laboratori le dipego',
            'quickActions.prescriptions': 'Ditaelo tša Dihlare',
            'quickActions.prescriptionsDesc': 'Laola dihlare tša gago tša bjale le go tlatša gape',
            'quickActions.medicalRecords': 'Direkoto tša Kalafi',
            'quickActions.medicalRecordsDesc': 'Fihlelela histori ya gago ye e feletšego ya kalafi',
            'quickActions.billing': 'Go Lefa & Ditefo',
            'quickActions.billingDesc': 'Lebelela dibill le go dira ditefo inthaneteng'
          }
        };
